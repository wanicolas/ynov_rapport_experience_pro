// -------------------------------------------------------------
// CHAPITRE IV : CONCLUSION & PERSPECTIVES
// -------------------------------------------------------------
...
Cette expérience m'a également permis d'acquérir une compréhension intime des spécificités du secteur public. Développer des logiciels pour les collectivités territoriales m'a appris que la qualité d'une interface ne se mesure pas uniquement à son élégance visuelle, mais avant tout à sa robustesse, à son accessibilité universelle pour tous les citoyens et à son efficacité au service du bien commun.

== Perspectives d'évolution pour Logitud Solutions et la plateforme Mon-Guichet
...
À l'issue de cette formation de Mastère 2, mon projet professionnel est clairement défini : je souhaite poursuivre ma carrière en tant que *Lead Développeur Front-End* ou *Architecte d'Applications Web* avec une approche centrée sur l'accessibilité et le DevSecOps.

Mon ambition est de continuer à concevoir des architectures front-end modernes, exigeantes et pérennes, en alliant la rigueur du typage statique, l'efficacité des méthodes DevOps et la créativité dans la conception d'interfaces utilisateur intuitives. Cette alternance de quatre ans m'a apporté la maturité technique, méthodologique et relationnelle indispensable pour aborder avec confiance et détermination les défis de l'ingénierie logicielle de demain.

#pagebreak()

// -------------------------------------------------------------
// WEBOGRAPHIE & RÉFÉRENCES TECHNIQUES
// -------------------------------------------------------------
...
4. *Référentiel Général d'Amélioration de l'Accessibilité (RGAA 4.1.2) :* \
  #link("https://accessibilite.numerique.gouv.fr")[https://accessibilite.numerique.gouv.fr] — Critères et règles de conformité légale pour le secteur public français.
